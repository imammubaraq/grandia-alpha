    ...
    <div class="intro-y grid grid-cols-11 gap-5 mt-5">
        <div class="col-span-12 lg:col-span-4 2xl:col-span-3">
            <div class="box p-5 rounded-md">
                ...
                <div class="flex items-center mt-3"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i> <b>Metode Pembayaran:&nbsp;</b> Transfer Bank </div>
                ...
                <div class="box p-5 rounded-md mt-5">
                    ...
                    <div class="flex items-center"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i> <b>Nama Customer:</b> <a href="" class="underline decoration-dotted ml-1"><?= $invoice->name ?></a> </div>
