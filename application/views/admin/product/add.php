                    ...
                    <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                        ...
                        <div class="mt-5">
                            <div class="flex items-center text-slate-500">
                                ...
                                <div class="ml-2"> <span class="mr-1">Hindari menjual produk palsu/melanggar Hak Kekayaan Intelektual, agar produk Anda tidak terhapus.</span></div>
                            </div>
                        ...
                        <div class="mt-5">
                                ...
                                <div class="form-label xl:w-64 xl:!mr-10">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-2 px-2 py-0.5 bg-slate-200 text-slate-600 dark:bg-darkmode-300 dark:text-slate-400 text-xs rounded-md">Wajib Diisi</div>
                                        </div>
                                        <div class="leading-relaxed text-slate-500 text-xs mt-3"> Sertakan min. 40 karakter agar lebih menarik dan mudah ditemukan pembeli, terdiri dari jenis produk, merek, dan informasi seperti warna, bahan, atau jenis. </div>
                                    </div>
                                </div>
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="product-name" type="text" name="nama_brg" class="form-control" placeholder="Nama Produk">
                                    <div class="form-help text-right">Maximum karakter 0/70</div>
                                </div>
                            </div>
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                <div class="form-label xl:w-64 xl:!mr-10">
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    ...
                                    <div class="form-help text-right">Maximum karakter 0/255</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                        ...
                        <div class="mt-5">
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="product-stock" type="text" name="stok" class="form-control" placeholder="Input Stok Produk">
                                </div>
                            </div>
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                <div class="form-label xl:w-64 xl:!mr-10">
        ...
        <div class="intro-y col-span-2 hidden 2xl:block">
            <div class="pt-10 sticky top-0">
                <ul class="text-slate-500 relative before:content-[''] before:w-[2px] before:bg-slate-200 before:dark:bg-darkmode-600 before:h-full before:absolute before:left-0 before:z-[-1]">
                    ...
                    <li class="mb-4 border-l-2 pl-5 border-transparent dark:border-transparent"> <a href="">Variasi Produk</a> </li>
                    <li class="mb-4 border-l-2 pl-5 border-transparent dark:border-transparent"> <a href="">Variasi Produk (Details)</a> </li>
