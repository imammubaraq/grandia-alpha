    ...
    <div class="intro-y box overflow-hidden mt-5">
        <div class="border-b border-slate-200/60 dark:border-darkmode-400 text-center sm:text-left">
            <div class="px-5 py-10 sm:px-20 sm:py-20">
                ...
                <div class="mt-2"> Tanda  Terima <span class="font-medium">#<?= $invoice->order_id ?></span> </div>
                <div class="mt-1"><?= $invoice->transaction_time ?></div>
            </div>
            <div class="flex flex-col lg:flex-row px-5 sm:px-20 pt-10 pb-10 sm:pb-20">
                <div>
                    <div class="text-base text-slate-500">Detail Pembeli</div>
                ...
                <div class="lg:text-right mt-10 lg:mt-0 lg:ml-auto">
                    <div class="text-base text-slate-500">Pembayaran Dari</div>
                    <div class="text-lg font-medium text-primary mt-2">Grandia Publisher</div>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="whitespace-nowrap text-right">Unit Harga</th>
        ...
        <div class="px-5 sm:px-20 pb-10 sm:pb-20 flex flex-col-reverse sm:flex-row">
            <div class="text-center sm:text-left mt-10 sm:mt-0">
                ...
                <div class="text-lg text-primary font-medium mt-2">Transfer Bank</div>
                <div>
